...
int MapB::ch(int hashInt)
{
    int hashTo = hashInt % N;
    return hashTo;
}

int MapB::colission_handler(string s)
{
    int _toInsert = hFunction(s);
...
int MapB::searching(string s)
{
    int _toSearch = hFunction(s);
